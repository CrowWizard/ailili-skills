...
name: ecom-image2
description: |
  Source copy only. Runtime skill is ailili-aigc-imagegen-scenes
  (25 templates via local ailili-aigc-imagegen). Do not trigger this folder; do not use bash imagegen.sh or codex exec.
allowed-tools:
  - Bash
  - Read
version: 0.1.1
